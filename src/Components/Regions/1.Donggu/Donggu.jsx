...
function Donggu({info, setInfo, day, incolor = '#000', outcolor = '#000', backcolor = '#fff', hovercolor = '#34C759', outline = 5, inline = 2 }) {
    
    
    const [hoverIndex, setHoverIndex] = useState(null);
    const setRegion = (regionText) => {
        const temp = {...info};
        temp['selectRegions'][day] = `동구 ${regionText}`;
        setInfo(temp);
    }

    return (
        <div className="Donggu">
            <p onClick = {() => setRegion('공산동')} onMouseEnter={() => setHoverIndex(2)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 2 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>공산동</p>
            <p onClick = {() => setRegion('도평동')} onMouseEnter={() => setHoverIndex(12)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 12 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>도평동</p>
            <p onClick = {() => setRegion('해안동')} onMouseEnter={() => setHoverIndex(11)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 11 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>해안동</p>
            <p onClick = {() => setRegion('혁신동')} onMouseEnter={() => setHoverIndex(1)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 1 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>혁신동</p>
            <p onClick = {() => setRegion('안심동')} onMouseEnter={() => setHoverIndex(4)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 4 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>안심동</p>
            <p onClick = {() => setRegion('방촌동')} onMouseEnter={() => setHoverIndex(9)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 9 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>방촌동</p>
            <p onClick = {() => setRegion('동촌동')} onMouseEnter={() => setHoverIndex(6)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 6 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>동촌동</p>
            <p onClick = {() => setRegion('효목동')} onMouseEnter={() => setHoverIndex(8)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 8 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>효목동</p>
            <p onClick = {() => setRegion('신천동')} onMouseEnter={() => setHoverIndex(3)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 3 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>신천동</p>
            <p onClick = {() => setRegion('신암동')} onMouseEnter={() => setHoverIndex(5)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 5 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>신암동</p>
            <p onClick = {() => setRegion('지저동')} onMouseEnter={() => setHoverIndex(7)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 7 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>지저동</p>
            <p onClick = {() => setRegion('불로봉무동')} onMouseEnter={() => setHoverIndex(10)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 10 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>불로봉무동</p>

            <div className="mapWrap"> 
                <svg onClick = {() => setRegion('혁신동')} className="dong1" width="308" height="393" viewBox="0 0 308 393" fill= { hoverIndex === 1 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('공산동')} className="dong2" width="308" height="393" viewBox="0 0 308 393" fill= { hoverIndex === 2 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('신천동')} className="dong3" width="308" height="393" viewBox="0 0 308 393" fill= { hoverIndex === 3 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('안심동')} className="dong4" width="308" height="393" viewBox="0 0 308 393" fill= { hoverIndex === 4 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('신암동')} className="dong5" width="308" height="393" viewBox="0 0 308 393" fill= { hoverIndex === 5 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('동촌동')} className="dong6" width="308" height="393" viewBox="0 0 308 393" fill= { hoverIndex === 6 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('지저동')} className="dong7" width="308" height="393" viewBox="0 0 308 393" fill= { hoverIndex === 7 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('효목동')} className="dong8" width="308" height="393" viewBox="0 0 308 393" fill= { hoverIndex === 8 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('방촌동')} className="dong9" width="308" height="393" viewBox="0 0 308 393" fill= { hoverIndex === 9 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('불로동무동')} className="dong10" width="308" height="393" viewBox="0 0 308 393" fill= { hoverIndex === 10 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('해안동')} className="dong11" width="308" height="393" viewBox="0 0 308 393" fill= { hoverIndex === 11 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('도평동')} className="dong12" width="308" height="393" viewBox="0 0 308 393" fill= { hoverIndex === 12 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
