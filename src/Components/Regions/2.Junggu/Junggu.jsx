...
function Junggu({info, setInfo, day, incolor = '#000', outcolor = '#000', backcolor = '#fff', hovercolor = '#34C759', outline = 5, inline = 2 }) {

    const [hoverIndex, setHoverIndex] = useState(null);
    const setRegion = (regionText) => {
        const temp = {...info};
        temp['selectRegions'][day] = `중구 ${regionText}`;
        setInfo(temp);
    }
    return (
        <div className = 'Junggu'>
            <p onClick = {() => setRegion('동인동')} onMouseEnter={() => setHoverIndex(5)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 5 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>동인동</p>
            <p onClick = {() => setRegion('성내동')} onMouseEnter={() => setHoverIndex(0)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 0 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>성내동</p>
            <p onClick = {() => setRegion('삼덕동')} onMouseEnter={() => setHoverIndex(4)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 4 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>삼덕동</p>
            <p onClick = {() => setRegion('대봉동')} onMouseEnter={() => setHoverIndex(1)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 1 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>대봉동</p>
            <p onClick = {() => setRegion('남산동')} onMouseEnter={() => setHoverIndex(3)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 3 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>남산동</p>
            <p onClick = {() => setRegion('대신동')} onMouseEnter={() => setHoverIndex(2)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 2 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>대신동</p>
            <div>
                <svg onClick = {() => setRegion('성내동')} className = 'dong1' width="391" height="301" viewBox="0 0 391 301" fill = { hoverIndex === 0 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('대봉동')} className = 'dong2' width="391" height="301" viewBox="0 0 391 301" fill = { hoverIndex === 1 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('대신동')} className = 'dong3' width="391" height="301" viewBox="0 0 391 301" fill = { hoverIndex === 2 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('남산동')} className = 'dong4' width="391" height="301" viewBox="0 0 391 301" fill = { hoverIndex === 3 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('삼덕동')} className = 'dong5' width="391" height="301" viewBox="0 0 391 301" fill = { hoverIndex === 4 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('동인동')} className = 'dong6' width="391" height="301" viewBox="0 0 391 301" fill = { hoverIndex === 5 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
