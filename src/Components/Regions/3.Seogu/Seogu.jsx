...
function Seogu({info, setInfo, day, incolor = '#000', outcolor = '#000', backcolor = '#fff', hovercolor = '#34C759', outline = 5, inline = 2 }) {
    const [hoverIndex, setHoverIndex] = useState(null);

    const setRegion = (regionText) => {
        const temp = {...info};
        temp['selectRegions'][day] = `서구 ${regionText}`;
        setInfo(temp);
    }
    ...
    return (
        <div className = 'Seogu'>
            <p onClick = {() => setRegion('비산동')} onMouseEnter={() => setHoverIndex(2)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 2 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>비산동</p>
            <p onClick = {() => setRegion('원대동')} onMouseEnter={() => setHoverIndex(5)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 5 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>원대동</p>
            <p onClick = {() => setRegion('평리동')} onMouseEnter={() => setHoverIndex(1)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 1 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>평리동</p>
            <p onClick = {() => setRegion('내당동')} onMouseEnter={() => setHoverIndex(4)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 4 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>내당동</p>
            <p onClick = {() => setRegion('상중이동')} onMouseEnter={() => setHoverIndex(3)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 3 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>상중이동</p>
            <div>
                <svg onClick = {() => setRegion('원대동')} className = 'dong' width="382" height="305" viewBox="0 0 382 305" fill= { hoverIndex === 5 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('내당동')} className = 'dong' width="382" height="305" viewBox="0 0 382 305" fill= { hoverIndex === 4 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('상중이동')} className = 'dong' width="382" height="305" viewBox="0 0 382 305" fill= { hoverIndex === 3 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('비산동')} className = 'dong' width="382" height="305" viewBox="0 0 382 305" fill= { hoverIndex === 2 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('평리동')} className = 'dong' width="382" height="305" viewBox="0 0 382 305" fill= { hoverIndex === 1 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
