...
function Namgu({ incolor = '#000', outcolor = '#000', backcolor = '#fff', hovercolor = '#34C759', outline = 5, inline = 2 }) {
    ...
    return (
        <div className = 'Namgu'>
            ...
            <div>
                <svg className = 'dong' width="328" height="403" viewBox="0 0 328 403" fill= { hoverIndex === 1 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg className = 'dong' width="328" height="403" viewBox="0 0 328 403" fill= { hoverIndex === 2 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg className = 'dong' width="328" height="403" viewBox="0 0 328 403" fill= { hoverIndex === 3 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
