...
function Bukgu({info, setInfo, day, incolor = '#000', outcolor = '#000', backcolor = '#fff', hovercolor = '#34C759', outline = 5, inline = 2 }) {
    ...
    return (
        <div className = 'Bukgu'>
            <p onClick = {() => setRegion('읍내동')} onMouseEnter={() => setHoverIndex(13)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 13 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>읍내동</p>
            <p onClick = {() => setRegion('관음동')} onMouseEnter={() => setHoverIndex(14)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 14 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>관음동</p>
            <p onClick = {() => setRegion('동천동')} onMouseEnter={() => setHoverIndex(12)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 12 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>동천동</p>
            <p onClick = {() => setRegion('고성동')} onMouseEnter={() => setHoverIndex(4)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 4 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>고성동</p>
            <p onClick = {() => setRegion('칠성동')} onMouseEnter={() => setHoverIndex(3)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 3 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>칠성동</p>
            <p onClick = {() => setRegion('대현동')} onMouseEnter={() => setHoverIndex(1)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 1 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>대현동</p>
            <p onClick = {() => setRegion('복현동')} onMouseEnter={() => setHoverIndex(2)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 2 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>복현동</p>
            <p onClick = {() => setRegion('국우동')} onMouseEnter={() => setHoverIndex(10)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 10 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>국우동</p>
            <p onClick = {() => setRegion('구암동')} onMouseEnter={() => setHoverIndex(11)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 11 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>구암동</p>
            <p onClick = {() => setRegion('무태조야동')} onMouseEnter={() => setHoverIndex(9)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 9 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>무태조야동</p>
            <p onClick = {() => setRegion('태전동')} onMouseEnter={() => setHoverIndex(15)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 15 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>태전동</p>
            <p onClick = {() => setRegion('검단동')} onMouseEnter={() => setHoverIndex(8)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 8 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>검단동</p>
            <p onClick = {() => setRegion('침산동')} onMouseEnter={() => setHoverIndex(6)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 6 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>침산동</p>
            <p onClick = {() => setRegion('관문동')} onMouseEnter={() => setHoverIndex(16)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 16 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>관문동</p>
            <p onClick = {() => setRegion('산격동')} onMouseEnter={() => setHoverIndex(7)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 7 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>산격동</p>
            <p onClick = {() => setRegion('노원동')} onMouseEnter={() => setHoverIndex(5)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 5 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>노원동</p>
            

            <div>
                <svg onClick = {() => setRegion('대현동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 1 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('복현동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 2 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('칠성동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 3 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('고성동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 4 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('노원동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 5 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('침산동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 6 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('산격동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 7 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('검단동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 8 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('무태조야동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 9 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('국우동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 10 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('구암동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 11 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('동천동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 12 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('읍내동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 13 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('관음동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 14 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('태전동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 15 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('관문동')} className = 'dong' width="371" height="405" viewBox="0 0 371 405" fill= { hoverIndex === 16 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
