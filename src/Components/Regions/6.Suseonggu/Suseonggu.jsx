...
function Suseonggu({ incolor = '#000', outcolor = '#000', backcolor = '#fff', hovercolor = '#34C759', outline = 5, inline = 2 }) {
    ...
    return (
        <div className = 'Suseonggu'>
            ...
            <div>
                <svg className = 'dong' width="406" height="330" viewBox="0 0 406 330" fill= { hoverIndex === 1 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg className = 'dong' width="406" height="330" viewBox="0 0 406 330" fill= { hoverIndex === 2 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg className = 'dong' width="406" height="330" viewBox="0 0 406 330" fill= { hoverIndex === 3 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg className = 'dong' width="406" height="330" viewBox="0 0 406 330" fill= { hoverIndex === 4 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg className = 'dong' width="406" height="330" viewBox="0 0 406 330" fill= { hoverIndex === 5 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg className = 'dong' width="406" height="330" viewBox="0 0 406 330" fill= { hoverIndex === 6 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg className = 'dong' width="406" height="330" viewBox="0 0 406 330" fill= { hoverIndex === 7 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg className = 'dong' width="406" height="330" viewBox="0 0 406 330" fill= { hoverIndex === 8 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg className = 'dong' width="406" height="330" viewBox="0 0 406 330" fill= { hoverIndex === 9 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg className = 'dong' width="406" height="330" viewBox="0 0 406 330" fill= { hoverIndex === 10 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg className = 'dong' width="406" height="330" viewBox="0 0 406 330" fill= { hoverIndex === 11 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
