...
function Dalseonggun({info, setInfo, day, incolor = '#000', outcolor = '#000', backcolor = '#fff', hovercolor = '#34C759', outline = 5, inline = 2 }) {
    
    const [hoverIndex, setHoverIndex] = useState(null);
    const setRegion = (regionText) => {
        const temp = {...info};
        temp['selectRegions'][day] = `달성군 ${regionText}`;
        setInfo(temp);
    }

    return (
        <div className = 'Dalseonggun'>
            <p onClick = {() => setRegion('하빈면')} onMouseEnter={() => setHoverIndex(9)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 9 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>하빈면</p>
            <p onClick = {() => setRegion('다사읍')} onMouseEnter={() => setHoverIndex(8)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 8 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>다사읍</p>
            <p onClick = {() => setRegion('화원읍')} onMouseEnter={() => setHoverIndex(6)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 6 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>화원읍</p>
            <p onClick = {() => setRegion('가창면')} onMouseEnter={() => setHoverIndex(7)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 7 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>가창면</p>
            <p onClick = {() => setRegion('논공읍')} onMouseEnter={() => setHoverIndex(4)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 4 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>논공읍</p>
            <p onClick = {() => setRegion('옥포면')} onMouseEnter={() => setHoverIndex(5)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 5 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>옥포면</p>
            <p onClick = {() => setRegion('현풍면')} onMouseEnter={() => setHoverIndex(3)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 3 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>현풍면</p>
            <p onClick = {() => setRegion('유가면')} onMouseEnter={() => setHoverIndex(2)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 2 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>유가면</p>
            <p onClick = {() => setRegion('구지면')} onMouseEnter={() => setHoverIndex(1)} onMouseLeave={() => setHoverIndex(null)}
                style={{ color: hoverIndex === 1 ? 'var(--LM-main-color)' : 'var(--LM-mainouttext-color)' }}>구지면</p>
            

            <div>
                <svg onClick = {() => setRegion('구지면')} className = 'dong' width="347" height="410" viewBox="0 0 347 410" fill= { hoverIndex === 1 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('유가면')} className = 'dong' width="347" height="410" viewBox="0 0 347 410" fill= { hoverIndex === 2 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('현풍면')} className = 'dong' width="347" height="410" viewBox="0 0 347 410" fill= { hoverIndex === 3 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('논공읍')} className = 'dong' width="347" height="410" viewBox="0 0 347 410" fill= { hoverIndex === 4 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('옥포면')} className = 'dong' width="347" height="410" viewBox="0 0 347 410" fill= { hoverIndex === 5 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('화원읍')} className = 'dong' width="347" height="410" viewBox="0 0 347 410" fill= { hoverIndex === 6 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('가창면')} className = 'dong' width="347" height="410" viewBox="0 0 347 410" fill= { hoverIndex === 7 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('다사읍')} className = 'dong' width="347" height="410" viewBox="0 0 347 410" fill= { hoverIndex === 8 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
                ...
                <svg onClick = {() => setRegion('하빈면')} className = 'dong' width="347" height="410" viewBox="0 0 347 410" fill= { hoverIndex === 9 ? hovercolor : backcolor } xmlns="http://www.w3.org/2000/svg"
